...
namespace Hunter.NATS.Client
{
    ...
    public sealed class NATSOptions
    {
        ...
        int maxReconnect  = DefaultsOptions.MaxReconnect;
        int reconnectWait = DefaultsOptions.ReconnectWait;
        int pingInterval  = DefaultsOptions.PingInterval;
        int timeout       = DefaultsOptions.Timeout;
        ...
        /// </summary>
        public EventHandler<ConnectionEventArgs> ClosedEventHandler = null;

        /// <summary>
        /// Represents the method that will handle an event raised
        /// whenever a new server has joined the cluster.
        /// </summary>
        public EventHandler<ConnectionEventArgs> ServerDiscoveredEventHandler = null;

        /// <summary>
        /// Represents the method that will handle an event raised 
        /// when a connection has been disconnected from a server.
        /// </summary>
        public EventHandler<ConnectionEventArgs> DisconnectedEventHandler = null;

        /// <summary>
        /// Represents the method that will handle an event raised 
        /// when a connection has reconnected to a server.
        /// </summary>
        public EventHandler<ConnectionEventArgs> ReconnectedEventHandler = null;

        /// <summary>
        /// Represents the method that will handle an event raised 
        /// when an error occurs out of band.
        /// </summary>
        public EventHandler<ErrorEventArgs> AsyncErrorEventHandler = null;

        internal int maxPingsOut = DefaultsOptions.MaxPingOut;
        ...
        internal NATSOptions() { }

        // Copy constructor
        internal NATSOptions(NATSOptions o)
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether or not an <see cref="INATSConnection"/> will attempt
