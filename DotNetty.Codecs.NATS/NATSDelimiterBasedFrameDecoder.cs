...
namespace DotNetty.Codecs.NATS
{
    ...
    /// </remarks>
    public class NATSDelimiterBasedFrameDecoder : ByteToMessageDecoder
    {
        ...
        /// </param>
        public NATSDelimiterBasedFrameDecoder(int maxLength)
        ...
        /// </param>
        public NATSDelimiterBasedFrameDecoder(int maxLength, bool stripDelimiter, bool failFast)
        {
