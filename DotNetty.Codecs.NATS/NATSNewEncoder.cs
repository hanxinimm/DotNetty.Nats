...
namespace DotNetty.Codecs.NATS
{
    ...
    public sealed class NATSNewEncoder : MessageToMessageEncoder<NATSPacket>
    {
        ...
        internal static void DoEncode(IByteBufferAllocator bufferAllocator, dynamic packet, List<object> output)
        {
            //switch (packet.PacketType)
            //{
            //    case NATSPacketType.CONNECT:
            //        EncodeMessage(bufferAllocator, (ConnectPacket)packet, output);
            //        break;
            //    case NATSPacketType.PUB:
            //        EncodeMessage(bufferAllocator, (PublishPacket)packet, output);
            //        break;
            //    case NATSPacketType.SUB:
            //        EncodeMessage(bufferAllocator, (SubscribePacket)packet, output);
            //        break;
            //    case NATSPacketType.UNSUB:
            //        EncodeMessage(bufferAllocator, (UnSubscribePacket)packet, output);
            //        break;
            //    case NATSPacketType.PING:
            EncodeMessage(bufferAllocator, packet, output);
            //        break;
            //    case NATSPacketType.PONG:
            //        EncodeMessage(bufferAllocator, (PongPacket)packet, output);
            //        break;
            //    default:
        ...
        static void EncodeMessage(IByteBufferAllocator bufferAllocator, dynamic packet, List<object> output)
        {
            throw new ArgumentException("Unknown packet type: " + packet.PacketType, nameof(packet));
        }

        static void EncodeMessage(IByteBufferAllocator bufferAllocator, ConnectPacket packet, List<object> output)
        {
        ...
        static void EncodeMessage(IByteBufferAllocator bufferAllocator, PublishPacket packet, List<object> output)
        {
        ...
        static void EncodeMessage(IByteBufferAllocator bufferAllocator, SubscribePacket packet, List<object> output)
        {
        ...
        static void EncodeMessage(IByteBufferAllocator bufferAllocator, UnSubscribePacket packet, List<object> output)
        {
            byte[] IdBytes = EncodeStringInUtf8(packet.Id);
        ...
        static void EncodeMessage(IByteBufferAllocator bufferAllocator, PingPacket packet, List<object> output)
        {
            IByteBuffer buf = null;
            try
            {
        ...
        static void EncodeMessage(IByteBufferAllocator bufferAllocator, PongPacket packet, List<object> output)
        {
            IByteBuffer buf = null;
            try
            {
