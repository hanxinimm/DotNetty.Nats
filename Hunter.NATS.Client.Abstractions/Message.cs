...
namespace Hunter.NATS.Client
{
    ...
    public sealed class Message
    {
        ...
        private byte[] data;
        public ISubscription sub;

        /// <summary>
        /// Initializes a new instance of the <see cref="Message"/> class without any
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Message"/> class with a subject, reply, and data.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Message"/> class with a subject and data.
        /// </summary>
        /// <param name="subject">Subject of the message.</param>
        /// <param name="data">A byte array containing the message payload.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Message"/> class with a subject and no data.
        /// </summary>
        /// <param name="subject">Subject of the message.</param>
        ...
        public Message(MessageArgs arg, ISubscription s, byte[] payload, long length)
        {
            subject = arg.subject;
            reply   = arg.reply;
            sub     = s;
