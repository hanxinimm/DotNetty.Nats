...
namespace Hunter.NATS.Client
{
    ...
    /// </summary>
    public interface INATSConnection : INATSConnectionAsync, IDisposable
    {
        ...
        /// <summary>
        /// Sends a request payload and returns the response <see cref="Message"/>, or throws
        ...
        /// <returns>A <see cref="Message"/> with the response from the NATS server.</returns>
        /// <seealso cref="INATSConnection.Request(string, byte[])"/>
        Message Request(string subject, byte[] data, int timeout);

        /// <summary>
        /// Sends a sequence of bytes as the request payload and returns the response <see cref="Message"/>, or throws
        /// <see cref="NATSTimeoutException"/> if the <paramref name="timeout"/> expires.
        /// </summary>
        /// <remarks>
        ...
        /// <returns>A <see cref="Message"/> with the response from the NATS server.</returns>
        /// <seealso cref="INATSConnection.Request(string, byte[])"/>
        Message Request(string subject, byte[] data, int offset, int count, int timeout);

        /// <summary>
        /// Sends a request payload and returns the response <see cref="Message"/>.
        /// </summary>
        /// <remarks>
        ...
        /// to the connected NATS server.</param>
        /// <returns>A <see cref="Message"/> with the response from the NATS server.</returns>
        Message Request(string subject, byte[] data);

        /// <summary>
        /// Sends a sequence of bytes as the request payload and returns the response <see cref="Message"/>.
        /// </summary>
        /// <remarks>
        /// <para>NATS supports two flavors of request-reply messaging: point-to-point or one-to-many. Point-to-point
        /// involves the fastest or first to respond. In a one-to-many exchange, you set a limit on the number of 
        ...
        /// <param name="count">The number of bytes to be published to the subject.</param>
        /// <returns>A <see cref="Message"/> with the response from the NATS server.</returns>
        Message Request(string subject, byte[] data, int offset, int count);
        ...
        ISyncSubscription Subscribe(string subject);
        ...
        ISyncSubscription Subscribe(string subject, string queue);
        ...
        /// from the NATS Server on the given <paramref name="subject"/>.</returns>
        /// <seealso cref="ISubscription.Subject"/>
        IAsyncSubscription Subscribe(string subject, EventHandler<MessageHandlerEventArgs> handler);
        ...
        /// <seealso cref="ISubscription.Subject"/>
        /// <seealso cref="ISubscription.Queue"/>
        IAsyncSubscription Subscribe(string subject, string queue, EventHandler<MessageHandlerEventArgs> handler);
